...
def parse_opt():
    ...
    parser.add_argument('--start_num', type=int, default=0,
                    help='the start number of validation set')
    parser.add_argument('--end_num', type=int, default=1000,
                    help='the end number of validation set')
    parser.add_argument('--num_observed', type=int, default=1,
                    help='the number of observed words')
    parser.add_argument('--num_hidden', type=int, default=1,
                    help='the number of hidden words')
    parser.add_argument('--times', type=int, default=1,
                    help='the times of random selecting')
    parser.add_argument('--slack', type=float, default=1.,
                    help='hyper-paremeter in proposed method')
    parser.add_argument('--lamda', type=float, default=1e-1,
                    help='hyper-paremeter in proposed method')
    parser.add_argument('--save_as_images', action='store_true', default=False, 
                    help='whether save as image')
    parser.add_argument('--is_ssvm', action='store_true', default=False, 
                    help='which attack method to use (EM algorithm or structural svm)')
